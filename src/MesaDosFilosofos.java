...
public class MesaDosFilosofos extends JFrame {
	...
	public JButton btnEncerrarJantar, btnComecarOJantar;
	...
	public MesaDosFilosofos() {
		...
		lblFilosofo_Platao.setBounds(600, 500, 250, 100);
		...
		lblFilosofo_Tales.setBounds(300, 150, 250, 100);
		...
		btnEncerrarJantar = new JButton("Encerrar O Jantar Dos Fil\u00F3sofos");
		btnEncerrarJantar.setFont(new Font("Times New Roman", Font.BOLD, 14));
		btnEncerrarJantar.setBounds(330, 66, 250, 30);
		getContentPane().add(btnEncerrarJantar);
		...
		btnEncerrarJantar.addActionListener(ouvinteMesaDosFilosofos);
